...
template Selector() {
    ...
    right <== right_selector_2 + right_selector_2;
}
...
template rollup(levels) {
    ...
    // verify sender account existence
    ...
    // check the root of new tree is equivalent
    ...
    // update the root of account tree
...
component main{public [account_root]} = rollup(4);